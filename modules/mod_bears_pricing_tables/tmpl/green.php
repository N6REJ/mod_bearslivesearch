...
document.addEventListener('DOMContentLoaded', function() {
  document.querySelectorAll('.plan-features li .features-content').forEach(function(span) {
    // Remove icon HTML if present
    var iconHTML = '';
    var iconSpan = span.querySelector('.fa-li');
    if (iconSpan) {
    ...
    if (match) {
      span.innerHTML = iconHTML + '<span class="first-word">' + match[1] + '</span>' + match[2];
    }
  });
});
</script>
